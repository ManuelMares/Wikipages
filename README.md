This is an app created in cloud shell, with the use of Python,Js, HTML, Flask, Jinja and Pytest. The project also includes self deployment through git actions with yaml files and Continuous integration.
